...
var _user$project$Main$toDivs = function (matrix) {
...
var _user$project$Main$oneiftrue = F2(
	function (flag, sum) {
		return flag ? (sum + 1) : sum;
	});
var _user$project$Main$step = function (isOn) {
	return A2(
		_eeue56$elm_flat_matrix$Matrix$indexedMap,
		F3(
			function (x, y, value) {
				var ns = A3(_eeue56$elm_flat_matrix$Matrix_Extra$neighbours, x, y, isOn);
				var live_ns = A3(_elm_lang$core$List$foldr, _user$project$Main$oneiftrue, 0, ns);
				return value ? ((_elm_lang$core$Native_Utils.eq(live_ns, 2) || _elm_lang$core$Native_Utils.eq(live_ns, 3)) ? true : ((_elm_lang$core$Native_Utils.cmp(live_ns, 3) > 0) ? false : ((_elm_lang$core$Native_Utils.cmp(live_ns, 2) < 0) ? false : false))) : (_elm_lang$core$Native_Utils.eq(live_ns, 3) ? true : false);
			}),
		isOn);
};
var _user$project$Main$toggleLights = F2(
	function (index, cells) {
		return A2(
			...
			F3(
				function (x, y, cell) {
					return (_elm_lang$core$Native_Utils.eq(x, index.x) && _elm_lang$core$Native_Utils.eq(y, index.y)) ? _elm_lang$core$Basics$not(cell) : cell;
				}),
			cells);
	});
var _user$project$Main$isSolved = function (model) {
	return _elm_lang$core$Array$isEmpty(
		A2(_eeue56$elm_flat_matrix$Matrix$filter, _elm_lang$core$Basics$identity, model.isOn));
};
var _user$project$Main$init = {
	isOn: A3(_eeue56$elm_flat_matrix$Matrix$repeat, 12, 11, false),
	started: true
};
var _user$project$Main$initBar = function () {
	var x = A2(
		_eeue56$elm_flat_matrix$Matrix$indexedMap,
		F3(
			function (x, y, value) {
				return ((_elm_lang$core$Native_Utils.eq(x, 6) && _elm_lang$core$Native_Utils.eq(y, 3)) || ((_elm_lang$core$Native_Utils.eq(x, 6) && _elm_lang$core$Native_Utils.eq(y, 4)) || ((_elm_lang$core$Native_Utils.eq(x, 6) && _elm_lang$core$Native_Utils.eq(y, 5)) || ((_elm_lang$core$Native_Utils.eq(x, 5) && _elm_lang$core$Native_Utils.eq(y, 4)) || (_elm_lang$core$Native_Utils.eq(x, 7) && _elm_lang$core$Native_Utils.eq(y, 4)))))) ? true : false;
			}),
		_user$project$Main$init.isOn);
	return {
		ctor: '_Tuple2',
		_0: {isOn: x, started: true},
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Step':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							isOn: _user$project$Main$step(model.isOn)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Tick':
			...
			case 'Restart':
				return _user$project$Main$initBar;
			case 'Start':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {isOn: a, started: b};
	});
var _user$project$Main$LightIndex = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Main$Pause = {ctor: 'Pause'};
var _user$project$Main$Start = {ctor: 'Start'};
var _user$project$Main$start_pause = function (model) {
	return model.started ? A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						{ctor: '_Tuple2', _0: 'font-style', _1: 'bold'},
...
var _user$project$Main$subscriptions = function (model) {
	return model.started ? A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Main$Tick) : _elm_lang$core$Platform_Sub$none;
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Game Of Life in ELM')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('quiet')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Click on the cells to toggle and press \'Start\' to start simulation.')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_user$project$Main$start_pause(model),
				_elm_lang$html$Html$text('  '),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Main$toDivs(
				A2(_eeue56$elm_flat_matrix$Matrix$indexedMap, _user$project$Main$btn, model.isOn)),
				A2(
				_elm_lang$html$Html$hr,
				_elm_lang$core$Native_List.fromArray(
					[]),
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Main$initBar, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})
};
