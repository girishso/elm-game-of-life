		...
		return A2(
			...
			F3(
				function (x, y, value) {
					...
					var _p0 = A2(_elm_lang$core$Debug$log, 'live_ns', live_ns);
...
var _user$project$Main$winScreen = function (model) {
...
var _user$project$Main$init = {
	isOn: A3(_eeue56$elm_flat_matrix$Matrix$repeat, 6, 5, true)
};
var _user$project$Main$initBar = function () {
	var x = A2(
		...
		F3(
			function (x, y, value) {
				return (_elm_lang$core$Native_Utils.eq(x, 0) || _elm_lang$core$Native_Utils.eq(x, 2)) ? false : true;
			}),
	...
	function (msg, model) {
		...
		if (_p1.ctor === 'Toggle') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					isOn: A2(_user$project$Main$toggleLights, _p1._0, model.isOn)
				});
		} else {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$winScreen(model),
				A2(
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$Main$initBar, view: _user$project$Main$view, update: _user$project$Main$update})
};
